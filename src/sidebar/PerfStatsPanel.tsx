...
// packages/browser-extension → repo-root port: perf dashboard panel.
// Shows P50/P90/P99/SLO per operation in the sidebar. Polls GET_PERF_STATS
// from the SW on mount and on refresh click.
//
// [CM-OFFSCREEN-FIX] Ported from packages/browser-extension/src/sidebar/PerfStatsPanel.tsx
// so repo-root builds have the same perf visibility. The "Total" row
// (migrate_total) is the end-to-end user-perceived migration time — the
// number that matters. T1/T2/T3 (SW) rows are SW-internal handler times.
