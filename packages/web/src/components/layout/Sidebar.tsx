      ...
      <div className="shrink-0 border-t border-[#2A2A2A] p-3">
        <div className="flex items-center gap-2.5 rounded-[8px] px-2 py-2 transition-colors hover:bg-[#111111]">
          ...
          <div className="min-w-0 flex-1">
            ...
            {isPro && (
              <span className="mt-0.5 inline-flex items-center gap-1 rounded-full border border-[#00FF88]/30 bg-[#00FF88]/10 px-1.5 py-0.5 text-[9px] font-black uppercase tracking-widest text-[#00FF88]">
                <Zap size={8} className="shrink-0" /> Pro
              </span>
            )}
          </div>
          <button
