    ...
    <div className="bg-[#020202] bg-grid-pattern text-[#F5F5F5] font-sans overflow-x-hidden relative" style={{
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center pt-24 px-4 sm:px-8 lg:px-16 pb-16 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <p className="text-sm sm:text-base lg:text-xl text-[#6B6B6B] max-w-xl mx-auto mb-10 leading-relaxed animate-slide-up" style={{ animationDelay: "180ms" }}>
          ...
          <div className="flex flex-col items-center gap-3 mb-10 animate-fade-in" style={{ animationDelay: "340ms" }}>
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-5 opacity-50">
              {["Claude", "ChatGPT", "Gemini", "Grok", "Perplexity", "DeepSeek"].map(p => (
                <span key={p} className="text-[10px] sm:text-xs font-mono text-[#6B6B6B]">{p}</span>
              ))}
            </div>
          </div>
          ...
          <p className="text-[11px] sm:text-xs font-mono text-[#00FF88]/60 mb-10 animate-fade-in px-2" style={{ animationDelay: "420ms" }}>
            🔒 <strong className="text-[#00FF88]/80">Zero-knowledge</strong> — your data never leaves your machine · vault syncs to your Supabase · we cannot read your conversations
          </p>
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <div className="reveal rounded-[20px] p-8 sm:p-10 overflow-hidden relative" style={{
            ...
            <div className="block sm:hidden flex flex-col items-center gap-2 text-sm mb-4">
              <span style={{ color: "#CC785C" }}>Claude</span>
              <span className="text-[#00FF88]">→</span>
              <span style={{ color: "#74AA9C" }}>ChatGPT</span>
              <span className="text-[#00FF88]">→</span>
              <span style={{ color: "#4285F4" }}>Gemini</span>
              <span className="text-[#00FF88]">→</span>
              <span className="text-[#00FF88] font-bold">▸ ContextMover</span>
            </div>
            {/* Full desktop flow */}
      ...
      {/* ══════════════════════════ 6. HOW IT WORKS ══════════════════════════ */}
      <section id="how" className="py-12 sm:py-20 lg:py-32 px-4 sm:px-8 lg:px-16 relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
      ...
      {/* ══════════════════════════ 11. FOOTER ══════════════════════════ */}
      <footer className="py-14 px-4 sm:px-8 lg:px-16 bg-grid-pattern relative overflow-hidden" style={{
        background: "#010101",
