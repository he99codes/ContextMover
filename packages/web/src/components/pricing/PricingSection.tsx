  ...
  return (
    <section className="min-h-screen py-16 sm:py-24 px-4 sm:px-8 md:px-16" style={{ background: "#050505" }}>
      ...
      <div className="text-center">
        ...
        <p className="text-base sm:text-lg text-zinc-400 mt-3 max-w-xl mx-auto text-center">
      ...
      <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-4 mt-8 sm:mt-10">
        <span className={`text-xs sm:text-sm font-medium ${!isAnnual ? "text-white" : "text-zinc-500"}`}>
          Monthly
        </span>
        <button
      ...
      <div className="flex flex-col md:flex-row gap-6 items-stretch mt-12 max-w-5xl mx-auto">
        ...
        >
          <div>
            <div className="flex items-end gap-1">
              ...
              <span className="text-zinc-500 text-xs sm:text-sm mb-1 sm:mb-2">/ month</span>
            </div>
        ...
        >
          ...
          <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2">
            <span
              className="text-white text-[10px] sm:text-xs font-bold px-3 sm:px-4 py-1 rounded-full whitespace-nowrap"
          ...
          <div className="mt-4">
            {isAnnual ? (
              ...
              <div className="flex items-end gap-1">
                ...
                <span className="text-zinc-400 text-xs sm:text-sm mb-1 sm:mb-2">/ month</span>
              </div>
            )}
        ...
        >
          <div>
            {isAnnual ? (
              ...
              <div className="flex items-end gap-1">
                <span className="text-3xl sm:text-4xl md:text-5xl font-bold text-white">₹499</span>
                <span className="text-zinc-500 text-xs sm:text-sm mb-1 sm:mb-2">/ month</span>
              </div>
            )}
      ...
      <div className="text-center mt-8 sm:mt-10 space-y-2 px-4 sm:px-10 pb-8 sm:pb-10">
        <p className="text-zinc-500 text-base sm:text-xl">
