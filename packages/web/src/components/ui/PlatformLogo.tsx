...
export function ClaudeLogo({ size = 16, ...props }: LogoProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path d="M14.0 3.5H10.0L4 20.5H7.8L9.2 16.5H14.8L16.2 20.5H20L14.0 3.5ZM10.2 13.5L12 8.2L13.8 13.5H10.2Z" fill="currentColor"/>
    </svg>
  );
}
...
export function GeminiLogo({ size = 16, ...props }: LogoProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path d="M12 2C11.1 5.5 8.5 8.1 5 9 8.5 9.9 11.1 12.5 12 16c.9-3.5 3.5-6.1 7-7-3.5-.9-6.1-3.5-7-7Z" fill="currentColor"/>
      <path d="M12 16c-.9 3.5-3.5 5.5-7 6 3.5.5 6.1 0 7-6Z" fill="currentColor" opacity="0.6"/>
      <path d="M12 16c.9 3.5 3.5 5.5 7 6-3.5.5-6.1 0-7-6Z" fill="currentColor" opacity="0.6"/>
    </svg>
  );
}
...
export function PerplexityLogo({ size = 16, ...props }: LogoProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <path d="M9 8h4.5a2.5 2.5 0 0 1 0 5H9V8Zm0 5h6M9 8v8" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}
...
export function DeepSeekLogo({ size = 16, ...props }: LogoProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path d="M6 4h6a8 8 0 0 1 0 16H6V4Z" fill="none" stroke="currentColor" strokeWidth="1.5"/>
...
export const PLATFORM_COLORS: Record<string, string> = {
  // [CM-SOLAR] Warm metallic platform palette — claude orange, chatgpt gold,
  // perplexity gold, gemini/grok/deepseek silver. Pink reserved for accents.
  claude:     "#00FF88",
  chatgpt:    "#00C853",
  gemini:     "#E5E5E5",
  grok:       "#E5E5E5",
...
export function PlatformLogo({ platform, size = 16, ...props }: PlatformLogoProps) {
  ...
  // [CM-SOLAR] Logo inherits its platform color; silver default preserved for
  // standalone usage.
  return (
