...
export default function TermsPage() {
  return (
    <div className="min-h-screen bg-[#0A0A0A] text-[#F5F5F5]">
      <div
        className="mx-auto px-5 sm:px-6 pt-10 sm:pt-20 pb-12 sm:pb-20 w-full max-w-[760px]"
      >
        <Link
          href="/"
        ...
        >
          ...
          <Link href="/privacy" className="hover:text-[#F5F5F5] transition-colors flex items-center min-h-[44px] pr-4">
            Privacy Policy
          </Link>
        </div>
      </div>
