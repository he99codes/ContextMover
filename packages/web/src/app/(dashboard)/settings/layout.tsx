...
export default function SettingsLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <div className="shrink-0 border-b border-[#2A2A2A] bg-[#0A0A0A] px-8 pt-6 pb-0">
        <p className="text-[10px] font-mono uppercase tracking-[0.18em] text-[#3A3A3A] mb-3">
          Settings
        </p>
          ...
          {SETTINGS_TABS.map((tab) => {
            ...
            return (
              <Link
                ...
                href={tab.href}
                className={[
                  "relative px-4 pb-3 pt-0.5 text-sm font-medium transition-colors duration-150 -mb-px",
                  isActive
