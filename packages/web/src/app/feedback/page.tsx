...
export default function FeedbackPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] text-[#F5F5F5] font-sans flex flex-col items-center justify-center px-4 sm:px-5 py-16">
      ...
      <div className="w-full max-w-md bg-[#111111] border border-[#2A2A2A] rounded-2xl p-5 sm:p-8 shadow-[0_0_40px_rgba(0,0,0,0.6)]">
        ...
        {status === "success" ? (
          ...
          <>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {status === "error" && (
                <p className="text-xs text-[#00FF88]">Something went wrong. Please try again.</p>
              )}
