...
// MIRROR: detectPlatform (MUST match fetch-interceptor.ts:122-138)
function detectPlatform(url: string): string | null {
  ...
  // Perplexity: only REST API endpoints (/api/v3/ and /_next/server-action)
...
describe("3 · Fetch interceptor parsers (inline mirrors)", () => {
  describe("detectPlatform", () => {
    const cases: [string, string | null][] = [
      ["https://chatgpt.com/backend-api/conversation/abc123",    "chatgpt"],
      ["https://chat.openai.com/backend-api/conversation/xyz",    "chatgpt"],
      ["https://chatgpt.com/ces/v1/c/def456",                    "chatgpt"],
      ...
      ["https://www.perplexity.ai/api/v3/search",               "perplexity"],
      ["https://www.perplexity.ai/_next/server-action",         "perplexity"],
