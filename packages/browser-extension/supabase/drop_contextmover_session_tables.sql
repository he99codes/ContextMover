-- ContextMover — DROP session data tables from OUR Supabase
-- Run this manually in the ContextMover Supabase SQL Editor.
-- After running, ContextMover servers will NEVER store session content.
--
...
-- Drop session-related tables (ContextMover no longer stores these)
drop table if exists public.migrations cascade;
drop table if exists public.sessions cascade;

-- Keep these tables (ContextMover legitimately stores these):
